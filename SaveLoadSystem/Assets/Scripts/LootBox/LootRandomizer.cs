...
namespace LootBoxSystem
{
    public class LootRandomizer
    {
        ...
        public List<ItemData> GetItemData()
        {
            ...
            // Käy läpi jokaisen Itemin "Resources/Items" kansiosta, lisää ne oikeisiin Rarity tietokantoihin ja myös "AllItems" listaan
            ...
            // Palauttaa AllItems listan LootManageriin
            return AllItems;
        }
